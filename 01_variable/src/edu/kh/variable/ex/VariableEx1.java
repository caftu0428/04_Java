...
public class VariableEx1 {
	...
	public static void main(String[] args) {
		...
		// 변수 또는 값의 크기와 형식
		 ...
		 /* *** 자바 기본 자료형(Java Rrimitive Types) ****
		  * 
		  * [논리형]
		...
		double number1; // 메모리에 boolean 저장 공간 8byte 할당하고	
															// 그 공간을 number1 이로고 부르겠다
		...
		// 변수 선언 + 초기화 + 값의 범위 확인
		int number2 = 2100000000; // int 21억 오류 X,
		 ...
		 * */ 
		 ...
		 String str1 = "쌍따옴표가 String 리터러 표기법"; 
