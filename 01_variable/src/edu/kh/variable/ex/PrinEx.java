...
public class PrinEx {
	...
	public static void main(String[] args) {
		...
		// 20870132 아나                10000원 입금
		// 20870132 아파트관리비  150000원  출금
		// 20870132 식자재              5000원  출금
		
		// \n == 개행 문자(줄바꿈)
		System.out.printf("%8s  %-6s  %7d원 %s \n",
									"20870132", "홍길동", 10000, "입금");
		
		System.out.printf("%8s  %-6s  %7d원 %s \n",
				"20870132", "아파트과리비", 150000, "출금");
		
		System.out.printf("%8s  %-6s  %7d원 %s \n",
				         "20870132", "식자재", 5000, "출금");
