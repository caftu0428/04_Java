...
public class MapService {
	...
	public void method1() {
		...
		// - Map에 추가 시
		// 	 중복되는 key가 없으면 null
		// 	 중독되는 key가 있으면 이전 Value 반환
		
		System.out.println(map.put(1, "에그마요"));
		System.out.println(map.put(2, "로트세리바베큐"));
		...
		System.out.println("-----------------------------------");
		System.out.println("remve(2) : " + map.remove(2));
		System.out.println("remve(5) : " + map.remove(5));
		System.out.println(map);
	...
	/**
	 * Map 활용 하기 - DTO 대체하기
	 * - 서로 다른 데이터를 한 번에 묶어서 관리해아 하는 경우 
	 */
	public void method4() {
