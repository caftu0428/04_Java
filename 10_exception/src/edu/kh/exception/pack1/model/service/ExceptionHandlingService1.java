...
import java.util.Scanner;import javax.swing.plaf.ComponentInputMapUIResource;
...
public class ExceptionHandlingService1 {
	...
	public void method3() {
		...
		try {
			...
			if(input1 >=0) System.out.println(Double.POSITIVE_INFINITY); //  Infrinity
			else           System.out.println(Double.NEGATIVE_INFINITY); // -Infrinity
		}
	...
	public void method4() {
		...
		//	 입력되 값이 다른 자료형일 경우 발새되는(던져지는) 예외
...
//			}
			...
			// Unreachable catch block : 도달할 수 없는 catch 구문
				...
				input = -1; // 첫 반복에서 종료되 않게 input 수정
			}
...
//			throw new EOFException();
		...
		// -> 부모 타입 Exception으로 다 잡아서 처리(코디 길이 감소)
