...
public class ExceptionHandlingService3 {
	 ...
	 * 
	 * 
	 * - UnChecked Exception : 확인 안해되 되는 예외
	 * -> 예외 처리 구문(try-catch, throws)을
	 * 	  써도 그만, 안써도 그만인 예외
	 * 
	 */
	...
	public void method3() {
		...
		try {
			System.out.print("아무거나 입력해 : ");
			input = br.readLine();
			
			// 입력 받은 내용이 정수	 -> x 2 해서 출력하기
			// 입력 받은 내용이 문자열 -> 앞 뒤에 ### 붙이기
			
			// 입력 받ㅇ은 문자열 input을 정수로 변환
			...
			// 정수가 아닌 문자열에 입력되어 NumberFormatException이 발생한 경우
			// -> 문자열 입력이라는 소리!
	...
	public String inputString()	throws IOException{
		...
		// throws IOException :
		// 현재 메서드에 발생할 수 있는(던져질 수 있는) IOException을
		// 현재 메서드를 호출한 곳으로 던져서
		// 상황에 맞게 별도로 처리하게 함
...
//				throw new MoreThanAHundredException();
				throw new MoreThanAHundredException("100을 초과함");
			}
...
//			at edu.kh.exception.pack3.model.service.ExceptionHandlingService3.method5(ExceptionHandlingService3.java:216)
//			at edu.kh.exception.pack3.run.ExceptionHandlingRun3.main(ExceptionHandlingRun3.java:14)
