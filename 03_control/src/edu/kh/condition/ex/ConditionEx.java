...
public class ConditionEx {
	...
	public void method3a()	{
		...
		else if (month >= 3 && month <= 6)	result= "봄";
		else if (month >= 6 && month <= 8)	result= "여름";
		else if (month >= 9 && month <= 11)	result= "가을";
		else       result = "겨울";
...
//				case 3: case 4: case 5: result="봄"; break;
					case 3, 4, 5: result= "봄"; break; // month 3,4,5 인 경우
					case 6, 7, 8: result= "여름"; break; 
					case 9, 10, 11: result= "가을"; break;
					case 12, 2, 1: result= "겨울"; break;
				...
				public void method4() {
					...
					System.out.print("중간고사 성적을 입력하세요 : "); // 40%
					 int mid = sc.nextInt(); 
					 
					 System.out.print("기말고사 성적을 입력하세요 : ");  // 50%
					 int fin = sc.nextInt(); 
					 
					 System.out.print("과제 	점수를 입력하세요 : "); // 10%
...
//					String resut = null; 
					...
					//	resut=  "PASS";
						...
						switch( (int)(total / 10) ){
						case 10 : case 9 : result = "A올"; break;
						case 8 : result = "B다 "; break;
						case 7 : result = "C바"; break;
						case 6 : result = "어D"; break;
						}
				 ...
				 * 40점 미만 과목이 있으면 FAIL
				 * 평균이 60점 미만인 경우도 FALL
				 * 
				 * 모든 과복이 40점 이상, 평균 60점 이상인 경우 PASS
				 * 
				 * [출력 예시]
				 * 
